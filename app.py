...
questiondf = pd.read_csv("C:\\Users\\msi\\myproject\\question.csv")
asindf = pd.read_csv("C:\\Users\\msi\\myproject\\asindf.csv")
answerdf = pd.read_csv("C:\\Users\\msi\\myproject\\answer.csv")
features = pd.read_csv("C:\\Users\\msi\\myproject\\feature.csv")
...
def predict():
    ...
    if request.method == 'POST':
       ...
       with open('C:\\Users\\msi\\myproject\\dnntokenizer.pkl', 'rb') as f:
       ...
       with open('C:\\Users\\msi\\myproject\\asindftfidfvector.pkl', 'rb') as f:
           tfidf_vectorizer = pickle.load(f)
       with open('C:\\Users\\msi\\myproject\\asindftfidf.pkl', 'rb') as f:
       ...
       with open('C:\\Users\\msi\\myproject\\qtfidfvector.pkl', 'rb') as f:
           tfidf_vectorizer = pickle.load(f)
       with open('C:\\Users\\msi\\myproject\\questiontfidf.pkl', 'rb') as f:
           tfidf_matrix = pickle.load(f)
